      ...
      <div class="col-xl-9 col-lg-8 col-12">
        <div class="post-wrapper blog-details">
          ...
          <div class="single-blog">
            <a href="/">Home</a>&nbsp;>&nbsp;<a href="/pages/peristiwa_grid">Daftar Kilas Peristiwa</a>&nbsp;>&nbsp;<a href="" style=" pointer-events: none; cursor: default; margin-bottom : 10px;">Kilas Peristiwa</a>
            <div class="image-box">
            ...
            <div class="post-meta">
              ...
              <?php if ($berita['id_uploads'] != 0) { ?>
                <h4 class="title">Gambar Terkait Kilas Peristiwa</h4>
              ...
              ?>
                <div class="item">
                  <div class="single-blog">
                    ...
                    <div class="post-meta">
                      <h5 class="title"><a href="/pages/detail_peristiwa/<?= $a->id_berita ?>"><?= $cut_judul ?></a></h5>
