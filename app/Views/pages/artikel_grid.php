...
<div class="blog-grid section-spacing">
  <div class="container">
    <div class="row">
      <div class="col-xl-9 col-lg-8 col-12 our-blog">
        <div class="post-wrapper row">
          ...
          foreach ($berita as $a) :
            $date = $a['created_at'];
            if ($a['Kategori'] == 'Artikel' && $a['Status'] == 'Publik') :
              $text = $a['Isi'];
              $num_char = 50;
          ...
          ?>
              <div class="col-md-6 col-12">
                <div class="single-blog">
                  ...
                  <div class="post-meta">
                    <h5 class="title"><a href="/pages/detail_artikel/<?= $a['id_berita'] ?>"><?= $a['Judul'] ?></a></a></h5>
                    <p><?= $cut_text; ?></p>
    ...
    ?>
				<ul>
					<li class="clearfix">
						<img src="/gambar/<?= $b['Gambar']; ?>" alt="" class="float-left">
