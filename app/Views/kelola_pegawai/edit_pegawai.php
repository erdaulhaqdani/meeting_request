          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                ...
                <form action="/KelolaPegawai/update_pegawai/<?= $pegawai['idPegawai']; ?>" class="custom-validation" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                      <input class="form-control" type="text" placeholder="Masukkan nama lengkap" id="nama" name="nama" required value="<?= (old('nama')) ? old('nama') : $pegawai['nama'] ?>">
                    </div>
                  </div>
                  <!-- end row -->
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                      <select class="form-select" name="jenisKelamin" aria-label="Default select example" required value="<?= (old('jenisKelamin')) ? old('jenisKelamin') : $pegawai['jenisKelamin'] ?>">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                      <input class="form-control" type="text" placeholder="Masukkan NIP pegawai" id="nip" name="nip" required data-parsley-minlength="9" data-parsley-maxlength="15" value="<?= (old('nip')) ? old('nip') : $pegawai['nip'] ?>">
                    </div>
                  </div>
                  <!-- end row -->
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                      <input class="form-control" type="email" placeholder="Masukkan email pegawai" id="email" name="email" required value="<?= (old('email')) ? old('email') : $pegawai['email'] ?>">
                    </div>
                  </div>
                  <!-- end row -->
