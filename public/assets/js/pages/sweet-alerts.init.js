  ...
  (e.prototype.init = function () {
    t("#sa-basic").on("click", function () {
      ...
      t("#sa-success").click(function () {
        Swal.fire({ title: "Good job!", text: "You clicked the button!", icon: "success", showCancelButton: !0, confirmButtonColor: "#0f9cf3", cancelButtonColor: "#f32f53" });
      }),
      t("#sa-warning").click(function () {
        Swal.fire({ title: "Apakah anda yakin?", text: "You won't be able to revert this!", icon: "warning", showCancelButton: !0, confirmButtonColor: "#1cbb8c", cancelButtonColor: "#f32f53", confirmButtonText: "Iya, Hapus!" }).then(
          function (t) {
            t.value && Swal.fire("Dihapus!", "Meeting Request berhasil dihapus", "success");
          }
        );
      }),
      ...
      t("#sa-image").click(function () {
        Swal.fire({ title: "Sweet!", text: "Modal with a custom image.", imageUrl: "assets/images/logo-dark.png", imageHeight: 20, confirmButtonColor: "#0f9cf3", animation: !1 });
      }),
      ...
      t("#custom-padding-width-alert").click(function () {
        Swal.fire({ title: "Custom width, padding, background.", width: 600, padding: 100, confirmButtonColor: "#0f9cf3", background: "#fff url(//subtlepatterns2015.subtlepatterns.netdna-cdn.com/patterns/geometry.png)" });
      }),
      ...
      t("#chaining-alert").click(function () {
        Swal.mixin({ input: "text", confirmButtonText: "Next &rarr;", showCancelButton: !0, confirmButtonColor: "#0f9cf3", cancelButtonColor: "#74788d", progressSteps: ["1", "2", "3"] })
