...
!(function (V) {
  ...
  var he,
    ...
    Ae = function (e) {
      ...
      return { current: t, version: n, isEdge: r("Edge"), isChrome: r("Chrome"), isIE: r("IE"), isOpera: r("Opera"), isFirefox: r(Te), isSafari: r("Safari") };
    },
    De = {
      unknown: function () {
    ...
    Me = function (e) {
      ...
      return { current: t, version: n, isWindows: r(Oe), isiOS: r("iOS"), isAndroid: r(Be), isOSX: r("OSX"), isLinux: r("Linux"), isSolaris: r(Pe), isFreeBSD: r(Le), isChromeOS: r(Ie) };
    },
    Fe = {
      unknown: function () {
    ...
    bn = function (e, t, n) {
      ...
      if (((n = n || e), t)) {
        if (n === e && t.getBoundingClientRect && "static" === mn(Ne.fromDom(e), "position"))
          return { x: (a = (o = t.getBoundingClientRect()).left + (s.documentElement.scrollLeft || e.scrollLeft) - s.documentElement.clientLeft), y: (u = o.top + (s.documentElement.scrollTop || e.scrollTop) - s.documentElement.clientTop) };
  ...
  var $n = function (e, t) {
    ...
    rr = {
      ...
      windowsPhone: nr,
      browser: { current: Jn.current, version: Jn.version, isChrome: Jn.isChrome, isEdge: Jn.isEdge, isFirefox: Jn.isFirefox, isIE: Jn.isIE, isOpera: Jn.isOpera, isSafari: Jn.isSafari },
      os: { current: Qn.current, version: Qn.version, isAndroid: Qn.isAndroid, isChromeOS: Qn.isChromeOS, isFreeBSD: Qn.isFreeBSD, isiOS: Qn.isiOS, isLinux: Qn.isLinux, isOSX: Qn.isOSX, isSolaris: Qn.isSolaris, isWindows: Qn.isWindows },
      deviceType: { isDesktop: Zn.isDesktop, isiPad: Zn.isiPad, isiPhone: Zn.isiPhone, isPhone: Zn.isPhone, isTablet: Zn.isTablet, isTouch: Zn.isTouch, isWebView: Zn.isWebView },
    },
    or = Array.isArray,
    ir = function (e, t, n) {
      var r, o;
  ...
  function vr(p, g) {
    ...
    var b = function (e) {
      ...
      n = function (e, t, n) {
        ...
        if (((e = hr._addCacheSuffix(e)), y[e] ? (a = y[e]) : ((a = { passed: [], failed: [] }), (y[e] = a)), t && a.passed.push(t), n && a.failed.push(n), 1 !== a.status))
          if (2 !== a.status)
            if (3 !== a.status) {
              if (
                ((a.status = 1),
      ...
      decode: function (e) {
        return e.replace(Ur, function (e, t) {
          return t
            ...
            : Cr[e] || yr[e] || ((n = e), ((r = Ne.fromTag("div").dom()).innerHTML = n), r.textContent || r.innerText || n);
          var n, r;
        });
      },
    },
    ...
    eo = function (e) {
      var u,
        ...
        a = function (e, t, n) {
          ...
          for (t = t || "", "string" == typeof (n = n || []) && (n = Zr(n)), r = (e = Zr(e)).length; r--; ) (i = { attributes: a((o = Zr([u, t].join(" ")))), attributesOrder: o, children: a(n, Kr) }), (s[e[r]] = i);
        },
        c = function (e, t) {
          var n, r, o, i;
      ...
      return Wr[e]
        ...
        : ((u = "id accesskey class dir lang style tabindex title role"),
          ...
          "html4" !== e &&
            (c("input button select textarea", "autofocus"), c("input textarea", "placeholder"), c("a", "download"), c("link script img", "crossorigin"), c("img", "loading"), c("iframe", "sandbox seamless allowfullscreen loading")),
  ...
  function no(i) {
    ...
    i.valid_elements
      ...
      w("+ol[ul|ol],+ul[ul|ol]"),
      Yr({ dd: "dl", dt: "dl", li: "ul ol", td: "tr", th: "tr", tr: "tbody thead tfoot", tbody: "table", thead: "table", tfoot: "table", legend: "fieldset", area: "map", param: "video audio object" }, function (e, t) {
  ...
  var ro = "\ufeff",
    ...
    so = { keyLocation: 1, layerX: 1, layerY: 1, returnValue: 1, webkitMovementX: 1, webkitMovementY: 1, keyIdentifier: 1, mozPressure: 1 },
    co = function () {
      return !1;
    },
    lo = function () {
    ...
    po = function (e, t) {
      ...
      return (
        ...
        }) == ((r = o).isDefaultPrevented === lo || r.isDefaultPrevented === co) && ((o.isDefaultPrevented = co), (o.isPropagationStopped = co), (o.isImmediatePropagationStopped = co)),
              ...
              f.domLoaded && "ready" === u && "complete" === e.readyState
                ...
                : (f.hasMouseEnterLeave ||
                  ...
                  (i = f.events[o][u])
                    ...
                    : ((f.events[o][u] = i = [{ func: n, scope: r }]), (i.fakeName = s), (i.capture = l), (i.nativeHandler = c), "ready" === u ? go(e, c, f) : fo(e, s || u, c, l)));
          return (e = i = 0), n;
        }
      }),
  ...
  (yo = hi.support = {}),
          ...
          ? ((Ao = (To = s).documentElement),
            ...
            (Ho = t
              ? function (e, t) {
                  ...
                  return (
                    n ||
                    (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || (!yo.sortDetached && t.compareDocumentPosition(e) === n)
    ...
    (hi.matchesSelector = function (e, t) {
      if (((e.ownerDocument || e) !== To && Ro(e), (t = t.replace(oi, "='$1']")), yo.matchesSelector && Do && (!Bo || !Bo.test(t)) && (!Oo || !Oo.test(t))))
        try {
    ...
    ((bo = hi.selectors =
      {
        ...
        preFilter: {
          ...
          CHILD: function (e) {
            return (
              (e[1] = e[1].toLowerCase()),
              "nth" === e[1].slice(0, 3) ? (e[3] || hi.error(e[0]), (e[4] = +(e[4] ? e[5] + (e[6] || 1) : 2 * ("even" === e[3] || "odd" === e[3]))), (e[5] = +(e[7] + e[8] || "odd" === e[3]))) : e[3] && hi.error(e[0]),
              e
            );
          },
          PSEUDO: function (e) {
            ...
            return ui.CHILD.test(e[0])
              ? null
              : (e[3] ? (e[2] = e[4] || e[5] || "") : n && ii.test(n) && (t = xo(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))), e.slice(0, 3));
          },
        },
        filter: {
          TAG: function (e) {
            ...
            return 1 === p && 0 === g
              ...
              : function (e, t, n) {
                  ...
                  if (l) {
                    ...
                    else for (; (i = (++u && i && i[c]) || (a = u = 0) || s.pop()) && ((y ? i.nodeName.toLowerCase() !== f : 1 !== i.nodeType) || !++a || (d && ((i[Lo] || (i[Lo] = {}))[m] = [Mo, a]), i !== e)); );
    ...
    (xo = hi.tokenize =
      function (e, t) {
        ...
        for (a = e, u = [], s = bo.preFilter; a; ) {
          ...
          (n = !1),
          (r = ri.exec(a)) && ((n = r.shift()), o.push({ value: n, type: r[0].replace(ti, " ") }), (a = a.slice(n.length))),
          bo.filter))
            bo.filter.hasOwnProperty(i) && (!(r = ui[i].exec(a)) || (s[i] && !(r = s[i](r))) || ((n = r.shift()), o.push({ value: n, type: i, matches: r }), (a = a.slice(n.length))));
          if (!n) break;
        }
  ...
  (Ki.fn = Ki.prototype =
    {
      ...
      add: function (e, t) {
        ...
        if (!1 !== t) for (n = na.unique(this.toArray().concat(na.makeArray(e))), this.length = n.length, r = 0; r < n.length; r++) this[r] = n[r];
            ...
            ? ((e = e || ""),
              ...
              aa(e.split(","), function (e) {
                ...
                (e = hr._addCacheSuffix(e)),
                  o[e] ||
                    ((o[e] = !0),
                    (t = D("link", pe(pe({ rel: "stylesheet", type: "text/css", href: e }, u.contentCssCors ? { crossOrigin: "anonymous" } : {}), u.referrerPolicy ? { referrerPolicy: u.referrerPolicy } : {}))),
                    n.appendChild(t));
              }))
            : pa.DOM.loadCSS(e);
        },
  ...
  var ja,
    ...
    us = function (e) {
      ...
      return (
        ...
        !os(e) && Zu(e) && as(t)
          ? ((i = (r = e).ownerDocument), (a = ns(i)), (u = i.createTextNode(oo)), (s = r.parentNode).insertBefore(u, r), a.setStart(u, 0), a.setEnd(u, 1), (o = Lu(a.getBoundingClientRect())), s.removeChild(u), o)
          : as(t) && os(e)
          ? (function (e) {
              var t = e.startContainer,
                n = e.endContainer,
  ...
  var fs,
    ...
    Ds = function (e, t, n) {
      ...
      return m ? { name: (o = m.tagName), index: _s(n.dom, o, m) } : ((u = e), (c = t), (l = i), (f = (s = n).dom), ((d = {}).start = ks(f, u, c, l, !0)), s.isCollapsed() || (d.end = ks(f, u, c, l, !1)), d);
    },
    Os = function (e, t, n) {
    ...
    Ps = function (e, t, n) {
      return 2 === t ? Ds(lu, n, e) : 3 === t ? ((o = (r = e).getRng()), { start: ws(r.dom.getRoot(), ms.fromRangeStart(o)), end: ws(r.dom.getRoot(), ms.fromRangeEnd(o)) }) : t ? { rng: e.getRng() } : Bs(e, !1);
      var r, o;
    },
    Ls = N(Ds, d, !0),
    Is = "_mce_caret",
  ...
  var Dc,
    ...
    jc = function (e, t, n) {
      ...
      if (Bc(f)) {
        ...
        if (0 < e && d < f.childNodes.length && ((o = Uc(f, d)), Ic(o)))
          return Lc(o)
            ? ((s = n), (l = (c = o).nextSibling) && Ic(l) ? (Bc(l) ? ms(l, 0) : ms.before(l)) : jc(fs.Forwards, ms.after(c), s))
            : !Mc(o) && (i = vc(o, e, Fc, o))
            ? Bc(i)
              ? ms(i, 0)
              : ms.before(i)
    ...
    Ul = function (e, t, n, r) {
      ...
      $t(o) && o.hasChildNodes() && ((o = Hu(o, i)), Zt(o) && (i = 0)),
        ...
        (o = Dl(s, o)),
        (a = Dl(s, a)),
        (_l(o.parentNode) || _l(o)) && ((o = _l(o) ? o : o.parentNode), (o = t.collapsed ? o.previousSibling || o : o.nextSibling || o), Zt(o) && (i = t.collapsed ? o.length : 0)),
        (_l(a.parentNode) || _l(a)) && ((a = _l(a) ? a : a.parentNode), (a = t.collapsed ? a.nextSibling || a : a.previousSibling || a), Zt(a) && (u = t.collapsed ? 0 : a.length)),
        t.collapsed &&
      ...
      return (
        (n[0].inline || n[0].block_expand) && ((n[0].inline && Zt(o) && 0 !== i) || (o = Fl(s, n, o, i, a, u, !0)), (n[0].inline && Zt(a) && u !== a.nodeValue.length) || (a = Fl(s, n, o, i, a, u, !1))),
        n[0].selector && !1 !== n[0].expand && !n[0].inline && ((o = Il(s, n, t, o, "previousSibling")), (a = Il(s, n, t, a, "nextSibling"))),
        (n[0].block || n[0].selector) && ((o = Ml(e, n, o, "previousSibling")), (a = Ml(e, n, a, "nextSibling")), n[0].block && (s.isBlock(o) || (o = Fl(s, n, o, i, a, u, !0)), s.isBlock(a) || (a = Fl(s, n, o, i, a, u, !1)))),
    ...
    Xl = function (o, e) {
      return $u(
        ((a = (i = e).startContainer), (u = i.startOffset), Zt(a) ? (0 === u ? R.some(Ne.fromDom(a)) : R.none()) : R.from(a.childNodes[u]).map(Ne.fromDom)),
        ((n = (t = e).endContainer), (r = t.endOffset), Zt(n) ? (r === n.data.length ? R.some(Ne.fromDom(n)) : R.none()) : R.from(n.childNodes[r - 1]).map(Ne.fromDom)),
        function (e, t) {
          var n = K(Wl(o), N(at, e)),
            r = K(Kl(o), N(at, t));
            ...
            if (!v || (l = K.getElementRule(n))) {
              if (((f = !0), v && ((b = l.attributes), (C = l.attributePatterns)), (y = t[9]) ? ((g = -1 !== y.indexOf("data-mce-type")) && u && (f = !1), ((p = []).map = {}), y.replace(_, V)) : ((p = []).map = {}), v && !g)) {
                if (((w = l.attributesRequired), (x = l.attributesDefault), (S = l.attributesForced), l.removeEmptyAttrs && !p.length && (f = !1), S))
                  for (o = S.length; o--; ) (a = (d = S[o]).name), "{$uid}" === (T = d.value) && (T = "mce_" + P++), (p.map[a] = T), p.push({ name: a, value: T });
                if (x) for (o = x.length; o--; ) (a = (d = x[o]).name) in p.map || ("{$uid}" === (T = d.value) && (T = "mce_" + P++), (p.map[a] = T), p.push({ name: a, value: T }));
                if (w) {
  ...
  var wf,
    ...
    _f = function (e, t) {
      ...
      for (u = e.getTempAttrs(), s = l, c = new RegExp(["\\s?(" + u.join("|") + ')="[^"]+"'].join("|"), "gi"), l = s.replace(c, ""), a = d.getShortEndedElements(); (i = f.exec(l)); )
        (r = f.lastIndex), (o = i[0].length), (n = a[i[1]] ? r : kf.findEndTag(d, l, r)), (l = l.substring(0, r - o) + l.substring(n)), (f.lastIndex = r - o);
      return lu(l);
    },
    Rf = _f,
    Tf = function (e, t, n, r) {
      ...
      if (
        ...
        x === S &&
          ...
          p.isCollapsed() ||
            ...
            (C = y.startContainer),
            (w = y.startOffset),
            3 === C.nodeType && y.collapsed && (C.data[w] === oo ? (C.deleteData(w, 1), /[\u00a0| ]$/.test(b) || (b += " ")) : C.data[w - 1] === oo && (C.deleteData(w - 1, 1), /[\u00a0| ]$/.test(b) || (b = " " + b))),
            (t = b));
        var N,
          E,
          k,
          ...
          (function (n, e) {
            ...
            if (e) {
              ...
              (i = e.previousSibling) && 3 === i.nodeType
                ? (c.setStart(i, i.nodeValue.length), rr.ie || ((a = e.nextSibling) && 3 === a.nodeType && (i.appendData(a.data), a.parentNode.removeChild(a))))
            ...
            : ((t = u),
              ...
              0 === (r = s).length || /^\s+$/.test(r)
                ? ((a = '<br data-mce-bogus="1">'),
                  ...
                  (r = (i = Hs(t)) && t.schema.isValidChild(n.nodeName.toLowerCase(), i.toLowerCase()) ? ((r = a), t.dom.createHTML(i, t.settings.forced_root_block_attrs, r)) : r || '<br data-mce-bogus="1">'),
                  zm(t, r),
                  t.fire("SetContent", o))
                : ("raw" !== o.format && (r = hf({ validate: t.validate }, t.schema).serialize(t.parser.parse(r, { isRootContent: !0, insert: !0 }))),
    ...
    Vm = function (e) {
      ...
      return (
        t === r && Zt(t)
          ? 0 < n && n < t.nodeValue.length && ((t = (r = Hm(t, n)).previousSibling), n < o ? ((t = r = Hm(r, (o -= n)).previousSibling), (o = r.nodeValue.length), (n = 0)) : (o = 0))
          : (Zt(t) && 0 < n && n < t.nodeValue.length && ((t = Hm(t, n)), (n = 0)), Zt(r) && 0 < o && o < r.nodeValue.length && (o = (r = Hm(r, o).previousSibling).nodeValue.length)),
  ...
  var gp,
        ...
        ? ((f = e),
          ...
          m.block &&
            (v
              ...
              : h.isBlock(d) && !h.isBlock(g) && (Np(h, d, !1) || Np(h, d.firstChild, !0, !0) || d.insertBefore(h.create("br"), d.firstChild), Np(h, d, !0) || Np(h, d.lastChild, !1, !0) || d.appendChild(h.create("br")))),
        ...
        n = function (e) {
          ...
          if (m.split) {
            if (((o = Vm(o)), (t = wp(s, o, !0)) !== (n = wp(s, o)))) {
              ...
              (t = xp(u, t, "span", { id: "_start", "data-mce-type": "bookmark" })), (n = xp(u, n, "span", { id: "_end", "data-mce-type": "bookmark" }));
              var a = u.createRng();
              a.setStartAfter(t),
                a.setEndBefore(n),
                jl(u, a, function (e) {
          ...
          jl(u, o, function (e) {
            z(e, function (t) {
              ...
              z(["underline", "line-through", "overline"], function (e) {
                $t(t) && s.dom.getStyle(t, "text-decoration") === e && t.parentNode && Nl(u, t.parentNode) === e && Ep(s, { deep: !1, exact: !0, inline: "span", styles: { textDecoration: e } }, null, t);
              });
            });
          });
        };
          ...
          (c = O.inline || O.block),
              ...
              var a,
                u = function (e) {
                  ...
                  if (O.wrapper && Ym(R, e, T, A)) a = 0;
                    ...
                    !f || t || !yl(R, c, r) || !yl(R, o, c) || (!s && 3 === e.nodeType && 1 === e.nodeValue.length && 65279 === e.nodeValue.charCodeAt(0)) || Ms(e) || (O.inline && k.isBlock(e))
            ...
            Ip(_, function (e) {
              ...
              (!(1 < _.length) && k.isBlock(e)) || 0 !== t)
                ? (O.inline || O.wrapper) &&
                  (O.exact || 1 !== t || ((S = E((x = e))) && !ll(S) && Km(k, S, O) && ((N = k.clone(S, !1)), B(N), k.replace(N, x, !0), k.remove(S, !0)), (e = N || x)),
                  Lp(R, D, A, e),
                  (y = O),
                  (b = T),
                  (C = A),
                  ...
                  (a = k),
                  (s = e),
                  ("sub" !== (u = O).inline && "sup" !== u.inline) || (Dp(s, Op(a, "fontSize"), Bp(a, "fontSize", "")), a.remove(a.select("sup" === u.inline ? "sub" : "sup", s), !0)),
                  (r = k),
                  (o = O),
    ...
    qp = function (e, t) {
      for (var n, r = e.rows(), o = 0; o < r.length; o++) for (var i = r[o].cells(), a = 0; a < i.length; a++) if (at(i[a], t)) return R.some(((n = o), { x: x(a), y: x(n) }));
      return R.none();
    },
    ...
    ag = function (n) {
      ...
      return (
        ...
        -1 !== t.indexOf("</iframe>") ? { type: "fragmented", fragments: r, content: "", bookmark: null, beforeBookmark: null } : { type: "complete", fragments: null, content: t, bookmark: null, beforeBookmark: null }
      );
    },
    ug = function (e, t, n) {
    ...
    _g = function (e, t) {
      ...
      e.destroyed ||
        (t || e.removed
          ? (t || (e.editorManager.off("beforeunload", e._beforeUnload), e.theme && e.theme.destroy && e.theme.destroy(), Eg(i), Eg(a)),
            (r = (n = e).formElement) && (r._mceOldSubmit && ((r.submit = r._mceOldSubmit), (r._mceOldSubmit = null)), Ng.unbind(r, "submit reset", n.formEventDelegate)),
    ...
    jg = function (e, t, n, r, o) {
      var i,
        ...
        l,
        f,
        d = e ? { mobile: ((i = o.mobile || {}), (a = t), (u = { resize: !1, toolbar_mode: Ug(i, "scrolling"), toolbar_sticky: !1 }), pe(pe(pe({}, Lg), u), a ? { menubar: !1 } : {})) } : {},
        m = Mg(["mobile"], Tg(d, o)),
        p = hr.extend(
          n,
          r,
          ...
          e && Fg(f, "mobile")
            ...
            : {}),
          { validate: !0, external_plugins: ((s = r), (c = m.settings()), (l = c.external_plugins ? c.external_plugins : {}), s && s.external_plugins ? hr.extend({}, s.external_plugins, l) : l) }
        );
      return zg(e, m, r, p);
    },
    ...
    Qg = function (e, t, n) {
      var r,
        ...
        h = ((o = e.inline), (a = t), (u = n), (s = (i = g).dom().getBoundingClientRect()), { x: a - (o ? s.left + i.dom().clientLeft + Jg(i) : 0), y: u - (o ? s.top + i.dom().clientTop + Gg(i) : 0) });
  ...
  var fh = (function hE(r, o) {
    ...
    vh = function (e, t) {
      var n = (function (e, t) {
          ...
          var r = n[n.length - 1];
          return gh(r) ? { element: e, offset: t } : "img" === Rt(r) ? { element: r, offset: 1 } : Ot(r) ? { element: r, offset: ef(r).length } : { element: r, offset: ht(r).length };
        })(e, t),
      ...
      var D = function (e) {
        ...
        L = function (e) {
          ...
          (t = e.screenX - m),
            ...
            (w = w < 5 ? 5 : w),
            (x = x < 5 ? 5 : x),
            (D(c) && !1 !== s.getParam("resize_img_proportional", !0, "boolean") ? !Zh.modifierPressed(e) : Zh.modifierPressed(e)) && (R(t) > R(n) ? ((x = T(w * b)), (w = T(x / b))) : ((w = T(x / b)), (x = T(w * b)))),
            P(l, w, x),
        ...
        I = function () {
          ...
          e && (o("width", w), o("height", x)),
            ...
            E.remove(f),
            i(c),
            e && ((t = c), (n = w), (r = x), s.fire("ObjectResized", { target: t, width: n, height: r }), E.setAttrib(c, "style", E.getAttrib(c, "style"))),
            s.nodeChanged();
        },
        i = function (e) {
          var t, r, o, n, i;
            ...
            B(e) && !n.isDefaultPrevented()
              ? u(a, function (n, e) {
                  ...
                  (t = E.get("mceResizeHandle" + e)) && E.remove(t),
                    (t = E.add(A, "div", { id: "mceResizeHandle" + e, "data-mce-bogus": "all", class: "mce-resizehandle", unselectable: !0, style: "cursor:" + e + "-resize; margin:0; padding:0" })),
                    ...
                    E.bind(t, "mousedown", function (e) {
                      ...
                      e.stopImmediatePropagation(),
                        ...
                        (f = E.add(A, "div", { class: "mce-resize-helper", "data-mce-bogus": "all" }, v + " &times; " + y));
                    }),
                    (n.elm = t),
        ...
        o = function (e) {
          ...
          C ||
            ...
            n((t = E.$(t).closest("table,img,figure.image,hr")[0]), A) && (z(), n(r.getStart(!0), t) && n(r.getEnd(!0), t)) ? i(t) : M());
        },
        F = function (e) {
          return ev(
            (function (e, t) {
    ...
    av = function (u, s, e, c) {
      var n,
        ...
        m = function () {
          ...
          return (
            (t = (t = Fp(c, [t])[0]) || (r.createRange ? r.createRange() : r.body.createTextRange())).setStart && 9 === t.startContainer.nodeType && t.collapsed && ((n = u.getRoot()), t.setStart(n, 0), t.setEnd(n, 0)),
            ...
            return (
              ...
              (t = m())
                ? ((r = t.startContainer),
                  ...
                  3 === r.nodeType && 3 === o.nodeType && ((r = r.length === i ? Mh(r.nextSibling, !0) : r.parentNode), (o = 0 === a ? Mh(o.previousSibling, !1) : o.parentNode), r && r === o))
                    ? r
                    : n && 3 === n.nodeType
                    ? n.parentNode
                    : n)
      ...
      var i = o.blob_cache,
        t = function (t) {
          ...
          (e = t).attr("src") === rr.transparentSrc ||
            ...
            ((n = /data:([^;]+);base64,([a-z0-9\+\/=]+)/i.exec(r)) ? R.some({ type: n[1], data: decodeURIComponent(n[2]) }) : R.none())
              .filter(function () {
                return (function (e, t) {
            ...
            t = kf(
              {
                ...
                start: function (e, t, n) {
                  ...
                  if ((i = v ? T.getElementRule(e) : {})) {
                    for ((r = E(i.outputName || e, 1)).attributes = t, r.shortEnded = n, d.append(r), (u = h[d.name]) && h[r.name] && !u[r.name] && m.push(r), o = D.length; o--; )
                  ...
                  if ((n = v ? T.getElementRule(e) : {})) {
                    if (l[e] && !f) {
                      if ((t = d.firstChild) && 3 === t.type)
                        ...
                        else for (o = t.next, t.remove(), t = o; t && 3 === t.type; ) (r = t.value), (o = t.next), (0 !== r.length && !N.test(r)) || (t.remove(), (t = o)), (t = o);
                      if ((t = d.lastChild) && 3 === t.type)
                        if (0 < (r = t.value.replace(x, "")).length) (t.value = r), (t = t.prev);
                        else for (o = t.prev, t.remove(), t = o; t && 3 === t.type; ) (r = t.value), (o = t.prev), (0 !== r.length && !N.test(r)) || (t.remove(), (t = o)), (t = o);
                    }
              ...
              b &&
                ...
                (function () {
                  ...
                  if (T.isValidChild(_.name, b.toLowerCase())) {
                    for (; n; )
                      (e = n.next),
                        3 === n.type || (1 === n.type && "p" !== n.name && !l[n.name] && !n.attr("data-mce-type")) ? (t || ((t = E(b, 1)).attr(R.forced_root_block_attrs), _.insert(t, n)), t.append(n)) : (r(t), (t = null)),
                        (n = e);
                    r(t);
                  }
                })(),
                  ...
                  l(function (e) {
                    var t = U(e, function (e, t) {
                      var n,
                        ...
                        i = a[t].image;
                      return (
                        e.status && u.getParam("images_replace_blob_uris", !0, "boolean") ? (s.removeByUri(i.src), g(i, e.url)) : e.error && ((n = u), (r = e.error), ih(n, ka.translate(["Failed to upload image: {0}", r]))),
  ...
  var Uv,
    ...
    Vv = function (e, t) {
      var n,
        ...
        p = function (e) {
          var t, n, r;
          return (o = "string" == typeof e ? { name: e, classes: [], attrs: {} } : e), (t = Hv.create(o.name)), (n = t), (r = o).classes.length && Hv.addClass(n, r.classes.join(" ")), Hv.setAttribs(n, r.attrs), t;
        },
        g = function (n, e, t) {
          var r,
            o,
            ...
            f = 0 < e.length && e[0],
            d = f && f.name;
          if (((u = d), (s = "string" != typeof (a = n) ? a.nodeName.toLowerCase() : a), (c = m.getElementRule(s)), (i = !(!(l = c && c.parentsRequired) || !l.length) && (u && -1 !== hr.inArray(l, u) ? u : l[0]))))
      ...
      return "preview" in e && !1 === (u = e.preview)
        ...
        : ((t = e.block || e.inline || "span"),
          ...
          jv(u.split(" "), function (e) {
            ...
            if (
              !(("background-color" === e && /transparent|rgba\s*\([^)]+,\s*0\)/.test(t) && ((t = Hv.getStyle(n.getBody(), e, !0)), "#ffffff" === Hv.toHex(t).toLowerCase())) || ("color" === e && "#000000" === Hv.toHex(t).toLowerCase()))
            ) {
      ...
      n.on("init", function () {
        ...
        n.on("keyup", function (e) {
          ...
          e.isDefaultPrevented() ||
            ...
            i.get() && r.typing && !1 === lg(ag(n), r.data[0]) && (!1 === n.isDirty() && (n.setDirty(!0), n.fire("change", { level: r.data[0], lastLevel: null })), n.fire("TypingUndo"), i.set(!1), n.nodeChanged()));
        }),
        ...
        l = function (e, t) {
          if (
            ...
            (("" !== u.getAttrib(o, Gv)) === i && !t) ||
              (u.setAttrib(o, Gv, i ? c : null), u.setAttrib(o, "aria-placeholder", i ? c : null), (r = i), a.fire("PlaceholderToggle", { state: r }), a.on(i ? "keydown" : "keyup", l), a.off(i ? "keyup" : "keydown", l));
          }
        };
      c &&
  ...
  var wb = function (e, t) {
    ...
    xb = function (e, t, n, r) {
      for (var o, i, a, u, s, c, l = Hc(n), f = r, d = []; f && ((s = l), (c = f), (o = t === fs.Forwards ? s.next(c) : s.prev(c))); ) {
        if (rn(o.getNode(!1))) return t === fs.Forwards ? { positions: wb(t, d).concat([o]), breakType: eb.Br, breakAt: R.some(o) } : { positions: wb(t, d), breakType: eb.Br, breakAt: R.some(o) };
        if (o.isVisible()) {
          if (e(f, o)) {
    ...
    Pb = function (e, t, n) {
      ...
      if (n.collapsed && e.settings.forced_root_block) {
        ...
        (1 === t ? s : c)(ms.fromRangeStart(n)) ||
          ((a = (i = e).dom.create(Hs(i))), (!rr.ie || 11 <= rr.ie) && (a.innerHTML = '<br data-mce-bogus="1">'), (o = a), 1 === t ? e.$(r).after(o) : e.$(r).before(o), e.selection.select(o, !0), e.selection.collapse());
      }
    },
    Lb = function (l, f) {
      return function () {
    ...
    $b = function (e, t, n) {
      var r,
        ...
        a,
        u = e(t, n);
      return ((a = u).breakType === eb.Wrap && 0 === a.positions.length) || (!rn(n.getNode()) && (i = u).breakType === eb.Br && 1 === i.positions.length)
        ? ((r = e),
          (o = t),
          !u.breakAt
            .map(function (e) {
    ...
    Ow = function (a, e) {
      ...
      var x,
        ...
        _,
        R = !(!e || !e.ctrlKey);
      $t(s) && s.hasChildNodes() && ((p = i > s.childNodes.length - 1), (s = s.childNodes[Math.min(i, s.childNodes.length - 1)] || s), (i = p && Zt(s) ? s.nodeValue.length : 0)),
        (u = Tw(g, s)) &&
          (((m && !n) || (!m && n)) &&
    ...
    yx = function (l, e) {
      return R.some(e)
        ...
        .bind(function (e) {
          ...
          (u = (a = c).data),
          (s = ls(a, 0)),
          !(!gx(u, 0) || px(i, s) || ((a.data = " " + u.slice(1)), 0)) || vx(c) || ((t = l), (r = (n = c).data), (o = ls(n, r.length - 1)), !(!gx(r, r.length - 1) || px(t, o) || ((n.data = r.slice(0, -1) + " "), 0))))
            ? R.some(e)
            : R.none();
        });
    },
  ...
  function Ax(r) {
    ...
    "onselectionchange" in r.getDoc() ||
      r.on("NodeChange click mouseup keyup focus", function (e) {
        var t, n;
        (n = { startContainer: (t = r.selection.getRng()).startContainer, startOffset: t.startOffset, endContainer: t.endContainer, endOffset: t.endOffset }), ("nodechange" !== e.type && Uh(n, o)) || r.fire("SelectionChange"), (o = n);
      }),
  ...
  var Dx = function (e) {
          ...
          if (((i = s.getBody()), Ix((a = t)) && a !== i)) {
            ...
            (u.element = t),
              ...
              (u.ghost = (function (e, t, n, r) {
                ...
                return e.dom.setStyles(i, { position: "absolute", opacity: 0.5, overflow: "hidden", border: 0, padding: 0, margin: 0, width: n, height: r }), e.dom.setStyles(o, { margin: 0, boxSizing: "border-box" }), i.appendChild(o), i;
    ...
    Xx = function (g) {
      var h,
        ...
        s = function (e, t) {
          ...
          if (((l = f = n.cloneNode(!0)), (s = g.fire("ObjectSelected", { target: n, targetClone: l })).isDefaultPrevented())) return null;
          (r = $a(Ne.fromDom(g.getBody()), "#" + y).fold(
            ...
            l === f && rr.ie
              ...
              : (r.empty().append(oo).append(l).append(oo), e.setStart(r[0].firstChild, 1), e.setEnd(r[0].lastChild, 0)),
      ...
      return (
        ...
        rr.ie &&
          ...
          u.on("drop", function (e) {
            if (!v(e)) {
              var t = (i = e).dataTransfer && (a = i.dataTransfer.getData(g)) && 0 <= a.indexOf(p) ? ((a = a.substr(p.length).split(",")), { id: unescape(a[0]), html: unescape(a[1]) }) : null;
              if (t && t.id !== u.id) {
                e.preventDefault();
    ...
    nS = function (t, e) {
      ...
      c.inline || (t.getElement().style.visibility = t.orgVisibility),
        ...
        t.readonly || (t.inline && "static" === Gx.getStyle(n, "position", !0) && (n.style.position = "relative"), (n.contentEditable = t.getParam("content_editable_state", !0))),
        (n.disabled = !1),
        (t.editorUpload = Pv(t)),
        (t.schema = no(c)),
        (t.dom = ga(f, {
    ...
    fS = function (e) {
      ...
      var u,
        ...
        h =
          ...
          q(u.settings.theme)
            ...
            : D(u.settings.theme)
            ? ((c = (s = u).getElement()),
              (l = (0, s.settings.theme)(s, c)).editorContainer.nodeType && (l.editorContainer.id = l.editorContainer.id || s.id + "_parent"),
      ...
      return (
        ...
        e.inline
          ? nS(e)
          : ((g = iS((m = e), (p = h))),
            p.editorContainer && ((rS.get(p.editorContainer).style.display = m.orgDisplay), (m.hidden = rS.isHidden(p.editorContainer))),
    ...
    yS = function (e, t) {
      var n,
        ...
        o,
        i,
        a = "string" != typeof (n = t) ? ((r = hr.extend({ paste: n.paste, data: { paste: n.paste } }, n)), { content: n.content, details: r }) : { content: n, details: {} };
      ...
      ((LS.prototype.execCommand = function (t, n, r, e) {
        ...
        if (!u.editor.removed) {
          ...
          if (
            ...
            return !1;
          if (((i = t.toLowerCase()), (o = u.commands.exec[i]))) return o(i, n, r), u.editor.fire("ExecCommand", { command: t, ui: n, value: r }), !0;
          if (
  ...
  var US,
    ...
    ZS = pe(pe({}, jS), {
      ...
      toggleNativeEvent: function (e, t) {
        ...
        "focus" !== e &&
          "blur" !== e &&
          (t ? (n.initialized ? QS(n, e) : n._pendingNativeEvents ? n._pendingNativeEvents.push(e) : (n._pendingNativeEvents = [e])) : n.initialized && (n.dom.unbind(GS(n, e), e, n.delegates[e]), delete n.delegates[e]));
      },
    ...
    nN = function (t) {
      var e,
        n,
        r = xa("design"),
        o = xa({ design: { activate: f, deactivate: f, editorReadOnly: !1 }, readonly: { activate: f, deactivate: f, editorReadOnly: !0 } });
      return (
        (e = t).serializer
          ? XS(e)
    ...
    rN = hr.each,
    oN = hr.explode,
    iN = { f1: 112, f2: 113, f3: 114, f4: 115, f5: 116, f6: 117, f7: 118, f8: 119, f9: 120, f10: 121, f11: 122, f12: 123 },
    ...
    uN =
      ...
      (sN.prototype.createShortcut = function (e, t, n, r) {
        var o;
        return ((o = hr.map(oN(e, ">"), this.parseShortcut))[o.length - 1] = hr.extend(o[o.length - 1], { func: n, scope: r || this.editor })), hr.extend(o[0], { desc: this.editor.translate(t), subpatterns: o.slice(1) });
      }),
    ...
    wN =
        ...
        !(function (t) {
          ...
          if (ho.Event.domLoaded) {
            if (t.getElement() && rr.contentEditable) {
              ...
              o &&
                ((t.formElement = o),
                e.hidden_input && !Qt(t.getElement()) && (dS.insertAfter(dS.create("input", { type: "hidden", name: n }), n), (t.hasHiddenInput = !0)),
      ...
      (xN.prototype.execCallback = function (e) {
        ...
        if (o)
          return (
            ...
            "string" == typeof o && ((r = (r = o.replace(/\.\w+$/, "")) ? bN(r) : 0), (o = bN(o)), (this.callbackLookup = this.callbackLookup || {}), (this.callbackLookup[e] = { func: o, scope: r })),
            o.apply(r || this, t)
          );
      }),
      ...
      (xN.prototype.hide = function () {
        ...
        e.hidden ||
          ...
          e.save(),
          e.inline ? ((e.getBody().contentEditable = "false"), e === e.editorManager.focusedEditor && (e.editorManager.focusedEditor = null)) : (hN.hide(e.getContainer()), hN.setStyle(e.id, "display", e.orgDisplay)),
          (e.hidden = !0),
          e.fire("hide"));
      }),
  ...
  function xN(e, t, n) {
    ...
    (this.plugins = {}),
      ...
      this.settings.referrer_policy && (ba.ScriptLoader._setReferrerPolicy(this.settings.referrer_policy), ga.DOM.styleSheetLoader._setReferrerPolicy(this.settings.referrer_policy)),
  ...
  var fE,
    dE = {
            ...
            (n.toHsv = function () {
              return (
                ...
                (i = eE((e /= 255), eE((t /= 255), (n /= 255)))) === (a = tE(e, tE(t, n)))
                  ? { h: 0, s: 0, v: 100 * (o = i) }
                  : ((r = (a - i) / a), { h: nE(60 * ((e === i ? 3 : n === i ? 1 : 5) - (e === i ? t - n : n === i ? e - t : n - e) / ((o = a) - i))), s: nE(100 * r), v: nE(100 * o) })
              );
              var e, t, n, r, o, i, a;
            }),
            (n.toHex = function () {
      ...
      dom: { EventUtils: ho, Sizzle: hi, DomQuery: na, TreeWalker: ra, TextSeeker: uu, DOMUtils: ga, ScriptLoader: ba, RangeUtils: VN, Serializer: Av, ControlSelection: nv, BookmarkManager: Jh, Selection: av, Event: ho.Event },
      html: { Styles: ao, Entities: $r, Node: df, Schema: no, SaxParser: kf, DomParser: Ev, Writer: gf, Serializer: hf },
      Env: rr,
      AddOnManager: Ra,
      Annotator: af,
      Formatter: Wv,
