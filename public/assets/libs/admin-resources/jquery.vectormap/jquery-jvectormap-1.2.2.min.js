...
(jvm.$ = jQuery),
      ...
      var e,
        ...
        a = function (a) {
          ...
          a.type == "touchstart" && (u = 0),
            f.length == 1
              ? (u == 1 && ((h = n.transX), (p = n.transY), (n.transX -= (r - f[0].pageX) / n.scale), (n.transY -= (i - f[0].pageY) / n.scale), n.applyTransform(), n.label.hide(), (h != n.transX || p != n.transY) && a.preventDefault()),
                (r = f[0].pageX),
                (i = f[0].pageY))
              : f.length == 2 &&
                (u == 2
    ...
    setScale: function (e, t, n, r) {
      ...
      e > this.params.zoomMax * this.baseScale ? (e = this.params.zoomMax * this.baseScale) : e < this.params.zoomMin * this.baseScale && (e = this.params.zoomMin * this.baseScale),
        typeof t != "undefined" &&
          ...
          ((i = e / this.scale),
          r
            ? ((this.transX = t + (this.defaultWidth * (this.width / (this.defaultWidth * e))) / 2), (this.transY = n + (this.defaultHeight * (this.height / (this.defaultHeight * e))) / 2))
        ...
        for (u = 0; u < o.length; u++)
          this.regions[o[u]] &&
            ...
            i &&
              (typeof r == "undefined"
                ? (r = i)
                : ((s = { x: Math.min(r.x, i.x), y: Math.min(r.y, i.y), width: Math.max(r.x + r.width, i.x + i.width) - Math.min(r.x, i.x), height: Math.max(r.y + r.height, i.y + i.height) - Math.min(r.y, i.y) }), (r = s))));
  ...
  (jvm.WorldMap.defaultParams = {
    ...
    markersSelectable: !1,
    bindTouchEvents: !0,
    regionStyle: { initial: { fill: "white", "fill-opacity": 1, stroke: "none", "stroke-width": 0, "stroke-opacity": 1 }, hover: { "fill-opacity": 0.8 }, selected: { fill: "yellow" }, selectedHover: {} },
